...
function wprig_setup() {
	...
	add_theme_support( 'editor-color-palette', array(
		array(
			'name'  => __( 'Primary green', 'wprig' ),
			'slug'  => 'primary',
			'color' => '#4f8f95',
		),
		array(
			'name'  => __( 'Accent blue', 'wprig' ),
			'slug'  => 'accent-blue',
			'color' => '#4c7cbe',
		),
		array(
			'name'  => __( 'Light green', 'wprig' ),
			'slug'  => 'light-green',
			'color' => '#88a471',
		),
		array(
			'name'  => __( 'Dark green', 'wprig' ),
			'slug'  => 'dark-green',
			'color' => '#254022',
		),
		array(
		...
		array(
			'name'  => __( 'Dark gold', 'wprig' ),
			'slug'  => 'dark-gold',
			'color' => '#be822b',
		),
		array(
			'name'  => __( 'Light gold', 'wprig' ),
			'slug'  => 'light-gold',
			'color' => '#d6a94c',
		),
		array(
			'name'  => __( 'Neutral 1', 'wprig' ),
			'slug'  => 'neutral-1',
			'color' => '#b1c0bc',
		),
		array(
			'name'  => __( 'Neutral 2', 'wprig' ),
			'slug'  => 'neutral-2',
			'color' => '#ddd4ce',
		),
		array(
			'name'  => __( 'Neutral 3', 'wprig' ),
			'slug'  => 'neutral-3',
			'color' => '#e7eff0',
		),
		array(
